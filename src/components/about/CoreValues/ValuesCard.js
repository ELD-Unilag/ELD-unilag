...
const ValuesCard = (props) => {
  return (
    <div className={`min-w-[calc(50%-0.83rem)] h-[165px] ${props.bg} rounded-2xl relative overflow-hidden font-satoshi sm:min-w-0 sm:w-[165px] sm:max-w-[165px] lg:max-w-[335px] lg:w-[35%] lg:h-[230px]`}>
